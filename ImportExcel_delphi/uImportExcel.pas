...
uses
  ...
  Data.DB, ibx.IBCustomDataSet, ibx.IBDatabase, ibx.IBQuery, Vcl.DBGrids,
  Vcl.ExtCtrls, IdSSLOpenSSLHeaders, Vcl.ComCtrls
  {$ELSE}
  Windows, Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, Dialogs, Grids, comobj, StdCtrls,
  DB, IBCustomDataSet, IBDatabase, IBQuery, DBGrids,
...
type
  ...
  published
    ...
    procedure ExportarParaExcel(const pDataSet: TDataSet; pCaption: string);
  end;
  procedure Register;
...
procedure TImportExcel.ExportarParaExcel(const pDataSet: TDataSet; pCaption: string);
